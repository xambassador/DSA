...
function knapSackHelp(weight, value, maxWeight, start, end) {
    ...
    if(weight[start] <= maxWeight) {
        let ans1 = knapSackHelp(weight, value,maxWeight-weight[start], start+1,end) + values[start];
...
function knapSackMemo(weight, value, maxWeight, start, end, dp) {
    ...
    let ans = 0;
    if(weight[start] <= maxWeight) {
        let ans1 = knapSackMemo(weight, value,maxWeight-weight[start], start+1,end, dp) + values[start];
